...
Webflow.require('ix').init([
  {"slug":"reveal-gallery-image","name":"Reveal gallery image","value":{"style":{"opacity":0,"x":"0px","y":"80px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"20%","stepsA":[{"opacity":1,"transition":"opacity 400ms ease-in-out-sine 0, transform 400ms ease-in-sine 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"move-in-from-left","name":"move in from left","value":{"style":{"x":"-80px","y":"0px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"40%","stepsA":[{"opacity":1,"transition":"transform 600ms ease-out-sine 0, opacity 400ms ease-out-sine 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"rotate","name":"rotate","value":{"style":{"rotateX":"0deg","rotateY":"0deg","rotateZ":"10deg"},"triggers":[{"type":"scroll","offsetBot":"40%","stepsA":[{"opacity":1,"transition":"transform 600ms ease-out-sine 0, opacity 400ms ease-out-sine 0","rotateX":"0deg","rotateY":"0deg","rotateZ":"0deg"}],"stepsB":[]}]}},
  ...
  {"slug":"move-up-2","name":"move up 2","value":{"style":{"opacity":0,"x":"0px","y":"20vh","z":"0px"},"triggers":[{"type":"scroll","preload":true,"stepsA":[{"wait":"400ms"},{"opacity":1,"transition":"opacity 400ms ease-in-out 0, transform 800ms ease-out-expo 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"show-logo","name":"show logo","value":{"style":{"opacity":0,"x":"0px","y":"-100px","z":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":"200ms"},{"opacity":1,"transition":"transform 400ms ease-out-sine 0, height 400ms ease 0, opacity 200 ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"show-menu","name":"show menu","value":{"style":{"opacity":0,"x":"0px","y":"-100px","z":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":"400ms"},{"opacity":1,"transition":"transform 400ms ease-out-sine 0, height 400ms ease 0, opacity 200 ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  ...
  {"slug":"hide-scroll-button-on-scroll","name":"hide scroll button  on scroll","value":{"style":{},"triggers":[{"type":"scroll","selector":".scroll-down-button","offsetTop":"0%","stepsA":[],"stepsB":[{"opacity":0,"transition":"opacity 400ms ease 0"}]}]}},
  {"slug":"show-bg1","name":"show bg1","value":{"style":{},"triggers":[{"type":"scroll","selector":".bkg1","offsetBot":"0%","stepsA":[{"opacity":1,"transition":"opacity 400ms ease-in-out 0"}],"stepsB":[{"opacity":0,"transition":"opacity 400ms ease-in-out 0"}]}]}},
  {"slug":"show-bg-2","name":"show bg 2","value":{"style":{},"triggers":[{"type":"scroll","selector":".bkg2","offsetTop":"0%","offsetBot":"50%","stepsA":[{"opacity":1,"transition":"opacity 400ms ease-in-out 0"}],"stepsB":[{"opacity":0,"transition":"opacity 400ms ease-in-out 0"}]}]}},
  {"slug":"show-bg-3","name":"show bg 3","value":{"style":{},"triggers":[{"type":"scroll","selector":".bkg2","offsetTop":"0%","offsetBot":"50%","stepsA":[{"opacity":1,"transition":"opacity 400ms ease-in-out 0"}],"stepsB":[{"opacity":0,"transition":"opacity 400ms ease-in-out 0"}]}]}},
  {"slug":"hide-pagination","name":"hide pagination","value":{"style":{},"triggers":[{"type":"scroll","selector":".pagination","offsetBot":"50%","stepsA":[{"opacity":0,"transition":"opacity 200 ease 0"}],"stepsB":[{"opacity":1,"transition":"opacity 200 ease 0"}]}]}},
  {"slug":"loader","name":"Loader","value":{"style":{"display":"block","opacity":1},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":0,"transition":"opacity 400ms ease 0"},{"display":"none"}],"stepsB":[]}]}}
]);
